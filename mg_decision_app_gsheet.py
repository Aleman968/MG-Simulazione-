...
st.title("MG Decision App – Modalità SIMULAZIONE (salvataggio su Google Sheet)")
...
# ---------- Config da Streamlit Secrets ----------
# Nel pannello Streamlit Cloud → Settings → Secrets, inserisci:
# SHEET_ID="..."
# e la sezione [gcp_service_account] con le credenziali JSON (vedi README)
SHEET_ID = st.secrets.get("SHEET_ID", "")

if not SHEET_ID:
    st.error("Manca SHEET_ID in Streamlit Secrets. Vedi README.")
    st.stop()
...
st.subheader("Modifica / elimina (salva subito)")
